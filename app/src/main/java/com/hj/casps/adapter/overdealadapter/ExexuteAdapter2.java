...
public class ExexuteAdapter2 extends CommonAdapter<QuerySttleManageGain> {
    private String name;
    ...
    public static void setOnClickBillsListener(onClickBillsListener onClickBillsListener) {
        ExexuteAdapter2.onClickBillsListener = onClickBillsListener;
    }

    public ExexuteAdapter2(Context context, List<QuerySttleManageGain> datas) {
