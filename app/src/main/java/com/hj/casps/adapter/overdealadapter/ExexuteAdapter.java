...
public class ExexuteAdapter extends CommonAdapter<QuerySttleManageGain> {
    private String name;
    ...
    public ExexuteAdapter(Context context, List<QuerySttleManageGain> datas) {
...
//                executeGain.getMmbpayName() : executeGain.getMmbgetName();
        name = executeGain.getMmbpayId().equals(Constant.publicArg.getSys_member()) ?
                executeGain.getMmbgetName() : executeGain.getMmbpayName();
        ...
        hooder.setText(R.id.layout_4_tv_content, Constant.getNum(executeGain.getCtrMoney()));
        hooder.setText(R.id.layout_5_tv_content, "0.00");
