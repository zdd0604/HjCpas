...
public class ExexuteAdapter4 extends CommonAdapter<QuerySttleManageGain> {
    private String name;
    ...
    public static void setOnClickBillsListener(onClickBillsListener onClickBillsListener) {
        ExexuteAdapter4.onClickBillsListener = onClickBillsListener;
    }

    public ExexuteAdapter4(Context context, List<QuerySttleManageGain> datas) {
