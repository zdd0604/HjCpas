...
import com.hj.casps.adapter.overdealadapter.ExexuteAdapter4;
...
public class ExecuteFragment4 extends FragmentBase implements
        ExexuteAdapter4.onClickBillsListener,
        OnPullListener {
    private View view;
    private ListView listview;
    private List<QuerySttleManageGain> mList;
    private ExexuteAdapter4 mExexuteAdapter;
    private int fragment_type = 0;

    public ExecuteFragment4(int fragment_type) {
    ...
    private void initView() {
        ...
        ExexuteAdapter4.setOnClickBillsListener(this);
    ...
    private void setInitView() {
        if (pageNo == 0) {
            mExexuteAdapter = new ExexuteAdapter4(getActivity(), mList);
    ...
    public void onBtnClickListener(int pos) {
        //列表按钮点击效果
        LogShow(fragment_type + "4-----------:" + mList.get(pos).getCtrMoney());
