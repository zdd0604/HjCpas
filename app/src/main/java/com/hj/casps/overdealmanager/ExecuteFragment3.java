...
import com.hj.casps.adapter.overdealadapter.ExexuteAdapter3;
...
public class ExecuteFragment3 extends FragmentBase implements
        ExexuteAdapter3.onClickBillsListener,
        OnPullListener {
    private View view;
    private ListView listview;
    private List<QuerySttleManageGain> mList;
    private ExexuteAdapter3 mExexuteAdapter;
    private int fragment_type = 0;

    public ExecuteFragment3(int fragment_type) {
    ...
    private void initView() {
        ...
        ExexuteAdapter3.setOnClickBillsListener(this);
    ...
    private void setInitView() {
        if (pageNo == 0) {
            mExexuteAdapter = new ExexuteAdapter3(getActivity(), mList);
    ...
    public void onBtnClickListener(int pos) {
        //列表按钮点击效果
        LogShow(fragment_type + "3-----------:" + mList.get(pos).getCtrMoney());
