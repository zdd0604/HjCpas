...
public class ToEditMmbWarehouseLoading implements Serializable {
    private static final long serialVersionUID = 3407848157177188669L;
    ...
    public ToEditMmbWarehouseLoading(String sys_token, String sys_uuid, String sys_func, String sys_user, String sys_name, String sys_member, String id) {
    ...
    public ToEditMmbWarehouseLoading() {
    }
