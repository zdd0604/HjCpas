...
public class QuerySendGoodsLoading implements Serializable {
    private static final long serialVersionUID = -872721568521283696L;
    ...
    public QuerySendGoodsLoading(String sys_token, String sys_uuid, String sys_func, String sys_user, String sys_name, String sys_member, String orderId, String goodsName, String startFirst, String startEnd) {
