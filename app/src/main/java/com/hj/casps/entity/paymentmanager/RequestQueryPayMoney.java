...
public class RequestQueryPayMoney {
    ...
    private String sellersName;//                    string	收款方
    private String pageno;//              int	页号
    private String pagesize;//             	int	页行数



    public RequestQueryPayMoney(String sys_token, String sys_uuid, String sys_func, String sys_user, String sys_member, String ordertitleNumber, String goodsName, String sellersName, String pageno, String pagesize) {
