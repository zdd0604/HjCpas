 ...
 */
@Entity
public class NewQtListEntity implements Serializable{

    private static final long serialVersionUID = -7796444628716088022L;
    /**
     * goodname : 葵花油
    ...
    @Generated(hash = 913268834)
    public NewQtListEntity(String goodname, String goodsid, String id,
            String imgPath, double maxPrice, double minPrice, String mmbId,
            String mmbName, int num, long startEnd, long startTime) {
    ...
    @Generated(hash = 253866038)
    public NewQtListEntity() {
    }
