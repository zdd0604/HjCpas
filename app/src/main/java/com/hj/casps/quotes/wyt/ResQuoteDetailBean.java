 ...
 */
@Entity
public class ResQuoteDetailBean {
    /**
     * areaName : 北京市
    ...
    @Generated(hash = 501583432)
    public ResQuoteDetailBean(String quoteId, String areaName, String explan, String goodsId, String goodsName, double maxPrice, double minPrice, String mmbName, int num, int return_code, String return_message, long startEnd, long startTime, String pathlist) {
    ...
    @Generated(hash = 1710123160)
    public ResQuoteDetailBean() {
    }
